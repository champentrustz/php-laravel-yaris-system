            ...
            <div class="container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-type-material" method="GET" action="{{ url("/member/profile/update-profile") }}" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="first-name" name="first_name" value="{{$user->code}}" disabled>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="nick-name" name="nick_name" value="{{ $user->nick_name }}" required>
                            ...
                            <div class="custom-controls-stacked" >
                                ...
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="gender" value="MALE" <?php if($user->gender == "MALE")echo "checked"?> required>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">ชาย</span>
                                </label>

                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="gender" value="FEMALE" <?php if($user->gender == "FEMALE")echo "checked"?> required>
                                    <span class="custom-control-indicator"></span>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <select class="form-control" id="day" name="day"  >
                                            ...
                                            @for($i=1;$i<=31;$i++)
                                                <option value="{{$i}}" @if(substr($user->birthday,8,2) == $i) selected @endif>{{$i}}</option>
                                            @endfor
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <select class="form-control" id="month" name="month" >
                                            ...
                                            @for($i=1;$i<=12;$i++)
                                                <option value="{{$i}}" @if(substr($user->birthday,5,2) == $i) selected   @endif>{{$i}}</option>
                                            @endfor
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <select class="form-control" id="year" name="year" >
                                            ...
                                            @for($i=\Carbon\Carbon::now()->format('Y') + 543 - 100;$i<=\Carbon\Carbon::now()->format('Y') + 543;$i++)
                                                <option value="{{$i}}" @if(substr($user->birthday,0,4) == $i) selected @endif>{{$i}}</option>
                                            @endfor
                            ...
                            <div class="form-group">
                                <input type="number" name="telephone" class="form-control" id="telephone" value="{{ $user->telephone }}"  required>
                                <label for="telephone" style="font-weight: bold;">เบอร์ติดต่อ <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group">
                                <input type="text" name="facebook" class="form-control" value="{{ $user->facebook }}"  id="facebook">
                            ...
                            <div class="custom-controls-stacked" >
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="line_id_type" value="LINE_ID" <?php if($user->line_id_type == "LINE_ID")echo "checked";?> required>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Line ID</span>
                                </label>

                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="line_id_type" value="PHONE_NUMBER" <?php if($user->line_id_type == "PHONE_NUMBER")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                            ...
                            <div class="form-group">
                                <input type="text" name="line_id" class="form-control" id="line" value="{{ $user->line_id }}"  required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="house-number" name="house_number" value="{{ $user->userAddress->house_number }}" required>
                                <label for="house-number" style="font-weight: bold;">บ้านเลขที่ <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control" id="village-number" name="village_number" value="{{ $user->userAddress->village_number }}" required>
                                <label for="village-number" style="font-weight: bold;">หมู่ที่ <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control" id="alley" name="alley" value="{{ $user->userAddress->alley }}" required>
                                <label for="alley" style="font-weight: bold;">ตรอก/ซอย <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control" id="road" name="road" value="{{ $user->userAddress->road }}" required>
                                <label for="road" style="font-weight: bold;">ถนน <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control" id="sub-district" name="sub_district" value="{{ $user->userAddress->sub_district }}" required>
                                <label for="sub-district" style="font-weight: bold;">แขวง/ตำบล <span class="text-danger">*</span></label>
                            </div>


                            <div class="form-group">
                                <input type="text" class="form-control" id="district" name="district" value="{{ $user->userAddress->district }}" required>
                                <label for="district" style="font-weight: bold;">เขต/อำเภอ <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control" id="province" name="province" value="{{ $user->userAddress->province }}" required>
                                <label for="province" style="font-weight: bold;">จังหวัด <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control" id="country" name="country" value="{{ $user->userAddress->country }}" required>
                                <label for="country" style="font-weight: bold;">ประเทศ <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control" id="postal-code" name="postal_code" value="{{ $user->userAddress->postal_code }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="custom-controls-stacked" >
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="main_car_generation" value="YARIS_ATIV"  <?php if($user->userCar->main_car_generation == "YARIS_ATIV")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Yaris ATIV</span>
                                </label>

                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="main_car_generation" value="YARIS"  <?php if($user->userCar->main_car_generation == "YARIS")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                            ...
                            <div class="custom-controls-stacked"  >
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="secondary_car_generation" value="S" <?php if($user->userCar->secondary_car_generation == "S")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">S</span>
                                </label>

                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="secondary_car_generation" value="G" <?php if($user->userCar->secondary_car_generation == "G")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">G</span>
                                </label>

                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="secondary_car_generation" value="E" <?php if($user->userCar->secondary_car_generation == "E")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">E</span>
                                </label>

                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="secondary_car_generation" value="J" <?php if($user->userCar->secondary_car_generation == "J")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">J</span>
                                </label>

                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="secondary_car_generation" value="J_ECO" <?php if($user->userCar->secondary_car_generation == "J_ECO")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                            ...
                            <div class="form-group">
                                <select class="form-control" id="color" name="color" required>
                                    <option value="BLACK" <?php if($user->userCar->color == "BLACK") echo "selected"?>>Attitude Black Mica</option>
                                    <option value="BLUE" <?php if($user->userCar->color == "BLUE") echo "selected"?>>Dark Blue Mica Metallic</option>
                                    <option value="GREY" <?php if($user->userCar->color == "GREY") echo "selected"?>>Grey Metallic</option>
                                    <option value="SILVER" <?php if($user->userCar->color == "SILVER") echo "selected"?>>Silver Metallic</option>
                                    <option value="BROWN" <?php if($user->userCar->color == "BROWN") echo "selected"?>>Quartz Brown Metallic</option>
                                    <option value="WHITE" <?php if($user->userCar->color == "WHITE") echo "selected"?>>Super White</option>
                                    <option value="RED" <?php if($user->userCar->color == "RED") echo "selected"?>>Red Mica Metallic</option>
                                </select>
                            ...
                            <div class="custom-controls-stacked"  >
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="manufacture_year" value="2017" <?php if($user->userCar->manufacture_year == "2017")echo"checked";?> required>
                                    <span class="custom-control-indicator"></span>
                        ...
                        <div class="col-md-6 offset-md-3">
                            <br>
                        <button type="submit" class="btn btn-block btn-primary" >แก้ไขข้อมูล</button>
                        </div>
                </div>
                            </form>
                        </div>
